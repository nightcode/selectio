...
public class CellList<T> extends AbstractHasData<T> {
  ...
  public CellList(final Cell<T> cell) {
    this(cell, getDefaultResources(), null, DEFAULT_PAGE_SIZE);
  }
   ...
   */
  public CellList(final Cell<T> cell, Resources resources, int pageSize) {
    this(cell, resources, null, pageSize);
  }
  ...
  public CellList(final Cell<T> cell, ProvidesKey<T> keyProvider) {
    this(cell, getDefaultResources(), keyProvider, DEFAULT_PAGE_SIZE);
  }
   ...
   *          object should act as its own key
   */
  public CellList(final Cell<T> cell, Resources resources, ProvidesKey<T> keyProvider, int pageSize) {
    super(Document.get().createDivElement(), pageSize, keyProvider);
    this.cell = cell;
